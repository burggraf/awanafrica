...
import { UsersRound, Plus, AlertCircle } from "lucide-react"
    ...
    <div className="p-4 space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t("View and manage guardians for this club.")}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8 text-muted-foreground">
            <p>{t("Guardian management coming soon.")}</p>
            <p className="text-sm mt-2">
              {isAdmin 
                ? t("As an admin, you can view guardians across all clubs.")
                : t("As a club leader, you can manage guardians in your club.")
              }
            </p>
          </div>
        </CardContent>
