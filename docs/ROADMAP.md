...
## Overview
AwanAfrica is a management system designed for tracking Awana Clubs in Africa. It serves as a comprehensive tool for churches and schools to manage faith-based children's discipleship programs, specifically tailored to the unique needs of the African context.
...
The system is built around a hierarchical structure to mirror how Awana operates on the ground:
...
- **Weekly Club Tracking**: Quick-entry attendance for regular sessions.
- **Calendar Management**: Scheduling for the local school year.
- **Event Logistics**: Tracking attendance for special sessions.
...
### 6. Regional Events (Awana Games & Quiz)
- **Regional Organization**: Tools for organizing multi-church/school events.
- **Competition Management**: Scoring for regional Awana Games and Bible Quizzing.
- **Reporting**: Regional performance metrics and cross-club achievements.

### 7. Reporting & Analytics
- **Growth Metrics**: Visualizing enrollment trends.
- **Impact Reports**: Providing data for churches to see the reach of their discipleship efforts.
- **Exporting**: Generating PDFs or spreadsheets for physical record-keeping.

### 8. Localization (i18n & l10n)
- **Language Support**: Support for English, Swahili, and other regional languages.
- **Regional Formatting**: Accurate currency, date, and numeric formatting specific to countries like Tanzania, Kenya, Zambia, and Zimbabwe.
